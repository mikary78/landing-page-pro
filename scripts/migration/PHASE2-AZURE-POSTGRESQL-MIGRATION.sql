...
-- SQL Server 버전:
-- document_content TEXT → VARCHAR(MAX)
...
-- SQL Server 버전:
-- CREATE FUNCTION dbo.has_role (@user_id UNIQUEIDENTIFIER, @role VARCHAR(20))
-- RETURNS BIT AS
-- BEGIN
...
-- 3. TEXT vs VARCHAR(MAX)
--    PostgreSQL: TEXT 타입
--    SQL Server: VARCHAR(MAX) (최대 2GB)
