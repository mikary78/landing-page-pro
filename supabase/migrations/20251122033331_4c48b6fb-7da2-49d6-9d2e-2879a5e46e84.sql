...
ADD COLUMN ai_model TEXT NOT NULL DEFAULT 'gemini';

-- Create index for better query performance
CREATE INDEX idx_project_stages_project_ai ON public.project_stages(project_id, ai_model);

-- Create table for storing AI model results
CREATE TABLE public.project_ai_results (
